...
import questions from '../../questionsThree.json';
...
class PlayThree extends Component {
	constructor(props) {
		super(props);
		this.state = {
			questions,
	...
	startTimer = () => {
		const countDownTime = Date.now() + 3.6e6;
	...
	endGame = () => {
		...
		setTimeout(() => {
			this.props.history.push('/play/quizSummeryThree', playerStats);
		}, 1000);
	};
		...
		return (
			<Fragment>
				...
				<div className="questions">
					...
					<div class="tooltip">
						<span class="tooltiptext"> {currentQuestion.pinyin} </span>

...
import questions from '../../questionsTwo.json';
...
class PlayTwo extends Component {
	constructor(props) {
		super(props);
		this.state = {
			questions,
	...
	startTimer = () => {
		const countDownTime = Date.now() + 1.8e6;
	...
	endGame = () => {
		...
		setTimeout(() => {
			this.props.history.push('/play/quizSummaryTwo', playerStats);
		}, 1000);
	};
